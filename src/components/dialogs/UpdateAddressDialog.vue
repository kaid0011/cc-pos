  ...
  <q-dialog v-model="isOpen" persistent>
    <q-card style="width: 800px">
      <q-card-section class="dialog-header">
        <div class="text-body1 text-uppercase text-weight-bold">Update Address</div>
        <q-btn
          icon="close"
          flat
          dense
      ...
      <q-card-section class="dialog-body">
        <q-form @submit.prevent="handleUpdateAddress">
          ...
          <div class="row q-gutter-x-sm">
            <div class="col">
              <div class="dialog-label">
                Postal Code<span class="dialog-asterisk"></span>
              </div>
              <q-input
            ...
            <div class="">
              <div class="dialog-label">
                <span class="dialog-asterisk"></span>
              </div>
              <q-btn
          ...
          <div class="row q-col-gutter-x-sm q-col-gutter-y-md q-mb-md">
            <div class="col-4">
              <div class="dialog-label">
                Block No:<span class="dialog-asterisk"></span>
              </div>
              <q-input
            ...
            <div class="col-8">
              <div class="dialog-label">
                Road Name:<span class="dialog-asterisk"></span>
              </div>
              <q-input
                v-model="address.road_name"
                label="Road Name"
                outlined
                class="dialog-inputs"
              />
            ...
            <div class="col-8">
              <div class="dialog-label">
                Building Name:<span class="dialog-asterisk"></span>
              </div>
              <q-input
            ...
            <div class="col-4">
              <div class="dialog-label">
                Unit No:<span class="dialog-asterisk"></span>
              </div>
              <q-input
            ...
            <div class="col-9">
              <div class="dialog-label">
                Additional Information:<span class="dialog-asterisk"></span>
              </div>
              <q-input
                v-model="address.additional_info"
          ...
          <q-card-actions align="right">
            <q-btn label="Update Address" color="primary" type="submit" />
          </q-card-actions>
        </q-form>
      </q-card-section>
    </q-card>
  ...
  try {
    ...
    if (data.results && data.results.length > 0) {
      ...
      address.value.postal_code =
        result.POSTAL || address.value.postal_code.toUpperCase();
